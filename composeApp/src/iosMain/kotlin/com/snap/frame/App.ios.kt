...
private enum class Route { HOME, CROP, STUDIO }
...
actual fun App() {
    ...
    var originalBytesB64 by remember { mutableStateOf<String?>(null) }
    var croppedBytesB64 by remember { mutableStateOf<String?>(null) }
